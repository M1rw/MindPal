# backend/services/domain/voice/service.py
...
class TTSService:
    ...
    def __init__(
        ...
        *,
        ...
        if should_include_browser_fallback and not self._has_provider(configured_providers, "browser"):
    ...
    def _browser_fallback_allowed_now(self) -> bool:
        if not self._has_provider(list(self._providers), "browser"):
            return False
