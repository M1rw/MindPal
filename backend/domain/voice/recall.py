...
MEMORY_RESULT_CHARS = 1_200
CHATS_RESULT_CHARS = 1_500
MAX_CHAT_SESSIONS = 30
MAX_SNIPPETS = 3
SNIPPET_CHARS = 400
MAX_QUERY_CHARS = 200
...
NOTHING_FOUND = "Nothing relevant found. Do not guess or invent what they said before."
...
_STOP = {
    "the", "a", "an", "and", "or", "to", "of", "in", "on", "is", "it", "i", "you", "my",
    "me", "that", "this", "was", "for", "with", "what", "about", "do", "did", "we",
}
