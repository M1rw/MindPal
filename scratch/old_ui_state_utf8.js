...
// Orchestrates app state, theme, UI updates ΓÇö delegates utils to dedicated modules.
...
export function initializeTheme() {
  ...
  try {
    ...
    // Graceful fallback ΓÇö don't crash boot
    const prefersDark = window.matchMedia?.("(prefers-color-scheme: dark)")?.matches;
...
export function updateMentalHealthUI(profileResponse = null) {
  ...
  if (problemsDisplay) {
    if (clinical?.presenting_problems && clinical.presenting_problems.length > 0) {
      problemsDisplay.innerHTML = "ΓÇó " + clinical.presenting_problems.map(escapeHtml).join("<br>ΓÇó ");
    } else {
      problemsDisplay.innerHTML = `<span class="text-gray-400 dark:text-gray-600 italic">ΓÇó Stress management &nbsp; ΓÇó Sleep difficulties &nbsp; ΓÇó Mood regulation</span>`;
    }
  }

  if (diagnosesDisplay) {
    if (clinical?.suspected_diagnoses && clinical.suspected_diagnoses.length > 0) {
      diagnosesDisplay.innerHTML = "ΓÇó " + clinical.suspected_diagnoses.map(escapeHtml).join("<br>ΓÇó ");
    } else {
      diagnosesDisplay.innerHTML = `<span class="text-gray-400 dark:text-gray-600 italic">No observations yet ΓÇö continue chatting with MindPal Pro.</span>`;
    }
  }

  if (treatmentPlanDisplay) {
    treatmentPlanDisplay.textContent = clinical?.treatment_plan || "No active plan ΓÇö insights build over time through conversations.";
...
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
// escapeHtml ΓÇö exported for consumers (app.js, etc.)
// ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
