...
export function finalizeStatusIndicator(id, _elapsedMs) {
  // Completion time is operational telemetry, not user-facing reasoning.
  // Remove the transient activity indicator rather than exposing a “Thought for …” label.
