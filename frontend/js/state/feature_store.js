const SAFE_FEATURE_DEFAULTS = Object.freeze({
  "chat.standard_model": { title: "Standard chat", description: "Fast, warm peer support for everyday conversations.", lifecycle: "active", enabled: true, reason: "enabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "chat.pro_model": { title: "Pro chat", description: "Deeper reasoning and structured reflection tools.", lifecycle: "active", enabled: false, reason: "requires_authentication", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: "chat.standard_model", replacement_key: null, version: 1 },
  "chat.listening_styles": { title: "Listening styles", description: "Active Listen, Guided Coach, and Cognitive Tools modes.", lifecycle: "active", enabled: true, reason: "enabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "memory.local": { title: "Local memory", description: "Personal context stored on this device.", lifecycle: "active", enabled: true, reason: "enabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "memory.cloud_sync": { title: "Cloud sync", description: "Sync memory and conversations across signed-in devices.", lifecycle: "active", enabled: false, reason: "requires_authentication", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: "memory.local", replacement_key: null, version: 1 },
  "mental_health.insights": { title: "Mental-health insights", description: "Personal reflection summaries and screening history.", lifecycle: "beta", enabled: false, reason: "disabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: "chat.standard_model", replacement_key: null, version: 1 },
  "data.export": { title: "Conversation export", description: "Download the current local conversation.", lifecycle: "active", enabled: true, reason: "enabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "data.product_improvement": { title: "Product improvement signals", description: "Share anonymized product-quality signals.", lifecycle: "preview", enabled: false, reason: "preview_only", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "notifications.response_complete": { title: "Response-complete notifications", description: "Notify you when a reply finishes in the background.", lifecycle: "beta", enabled: true, reason: "enabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
  "notifications.streak_reminders": { title: "Streak reminders", description: "Gentle reminders when a reflection streak is at risk.", lifecycle: "beta", enabled: false, reason: "disabled", user_visible: true, user_toggleable: true, safety_critical: false, fallback_key: null, replacement_key: null, version: 1 },
