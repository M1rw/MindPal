...
export function initVoice({
  ...
  async function startVoiceCapture() {
    ...
    const confirmed = await confirmVoiceLanguageBeforeRecord(selectedLanguage, effectiveLocale);
