import { getLiveProviderCapabilities } from "../provider_policy.js";
import { createGeminiLiveAdapter } from "../provider/gemini_live_adapter.js";
import { buildGeminiLiveSetup } from "../provider/gemini_setup_builder.js";
import { createBrowserAudioAdapter } from "../capture/browser_audio_adapter.js";
import { createPlaybackManager } from "../playback/playback_manager.js";
import { createLocalCueManager } from "../playback/local_cue_manager.js";
import { createVoiceSessionOrchestrator } from "../orchestrator/voice_session_orchestrator.js";
import { createBackchannelManager } from "../backchannel/backchannel_manager.js";
import { createBackchannelProvider } from "../backchannel/backchannel_provider.js";
import { createResponseStagingManager } from "../staging/response_staging_manager.js";
import { createVoiceToolGateway } from "../tools/tool_gateway.js";
import { createEvidenceGate } from "../evidence/evidence_gate.js";
import { createRecoverySupervisor } from "../transport/recovery_supervisor.js";
import { createVoiceSessionPersistence } from "../lifecycle/session_persistence.js";
import { executeToolClientSide, createToolExecutor } from "../tools.js";
...
import { VOICE_EVENTS } from "../architecture/events.js";
import { classifyFinalizedVoiceTurn, buildOperationIdentity } from "../intent/finalized_turn_router.js";
import { createTranscriptAssembler } from "../transcript_assembler.js";
