...
### Backend
- `docs/backend/rag-clinical-frameworks.md` — RAG grounding and clinical technique guidance
- `docs/backend/memory-v3.md` — Adaptive Cortical Memory (ACM) graph system
...
- `docs/backend/prompt-engineering.md` — System prompt construction, agent chains, language handling
...
8. Settings option toggles respond only to the toggle control, not the label text.
