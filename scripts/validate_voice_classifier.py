...
Usage:
    python scripts/validate_voice_classifier.py
    python scripts/validate_voice_classifier.py --models gemini-2.5-flash-lite,gemini-2.5-flash
    python scripts/validate_voice_classifier.py --repeat 3      # check determinism
