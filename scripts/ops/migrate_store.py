"""Copy MindPal documents between storage providers, keeping document ids.
    ...
    python scripts/ops/migrate_store.py --from firestore --to supabase
    python scripts/ops/migrate_store.py --from supabase --to firestore --collections memory_graphs,chat_sessions
