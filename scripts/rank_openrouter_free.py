...
Usage:
    python scripts/rank_openrouter_free.py
    python scripts/rank_openrouter_free.py --top 6 --json   # feed the validator
"""
...
def main() -> int:
    ...
    print(f"    python scripts/validate_voice_classifier.py --provider openrouter \\")
